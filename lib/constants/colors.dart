...
const Color bgColorDarkTheme = Color.fromARGB(255, 30, 27, 27);
...
const Color russianViolet = Color(0xFF3A015C);
const Color platinum = Color(0xFFD8DBE2);
const Color eerieBlack = Color(0xFF1E1B1B);
const Color jett = Color(0xFF323030);
const Color onyx = Color(0xFF454343);
const Color davyGrey = Color(0xFF565454);
